...
@testset "TopListArchive" begin
    ...
    @testset "Constructing a small archive and adding to it" begin
        ...
        @test fitness_improvement_potential(a, 0.05) ≈ (expected / 0.5)
        ...
        @test width_of_confidence_interval(a, 0.05) ≈ expected
        @test fitness_improvement_potential(a, 0.05) ≈ (expected / 0.4)
    ...
    @testset "magnitude_class for positive fitness values" begin
        ...
        @test BlackBoxOptim.magnitude_class(1.0e2) == (1.0, 2.0)
        @test BlackBoxOptim.magnitude_class(1.0e102) == (1.0, 102.0)
        @test BlackBoxOptim.magnitude_class(1.0e-1) == (1.0, -1.0)
        @test BlackBoxOptim.magnitude_class(1.0e-2) == (1.0, -2.0)
        @test BlackBoxOptim.magnitude_class(1.0e-9) == (1.0, -9.0)
        @test BlackBoxOptim.magnitude_class(1.0e-12) == (1.0, -12.0)
