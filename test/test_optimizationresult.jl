...
@testset "general_stop_reason" begin
    ...
    @testset "Within fitness tolerance" begin
        ...
        res = bboptimize(
            problem; NumDimensions = 1, TraceMode = :silent,
            FitnessTolerance = 1.0e-1, MinDeltaFitnessTolerance = 1.0e-100
        )
    ...
    @testset "Delta fitness below tolerance" begin
        ...
        res = bboptimize(
            problem; NumDimensions = 1, TraceMode = :silent,
            MinDeltaFitnessTolerance = 1.0e-1, FitnessTolerance = 1.0e-100
        )
