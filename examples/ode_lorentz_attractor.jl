...
function lorentz_ode!(
        dr::AbstractVector{Float64},
...
calc_states(
    ...
    calc_states!(
    Matrix{Float64}(undef, length(startx), length(times)),
...
Xiang2015Bounds = [(9.0, 11.0), (20.0, 30.0), (2.0, 3.0)]
...
origstates1_Xiang2015, times1_Xiang2015 = subsample(origstates_Xiang2015, t_Xiang2015; lenratio = 1.0);

res1 = bboptimize(
    params -> lorentz_fitness(params, origstates1, times1);
    SearchRange = Xiang2015Bounds, MaxSteps = 8.0e3
)

res2 = bboptimize(
    params -> lorentz_fitness(params, origstates1_Xiang2015, times1_Xiang2015);
    SearchRange = Xiang2015Bounds, MaxSteps = 11.0e3
) # They allow 12k fitness evals for 3-param estimation

# But lets also try with less tight bounds
LooserBounds = [(0.0, 22.0), (0.0, 60.0), (1.0, 6.0)]
res3 = bboptimize(
    params -> lorentz_fitness(params, origstates1_Xiang2015, times1_Xiang2015);
    SearchRange = LooserBounds, MaxSteps = 11.0e3
) # They allow 12k fitness evals for 3-param estimation
