...
@assert isapprox(best[1], 1.0, atol = 1.0e-5)
@assert isapprox(best[2], 4.74299963, atol = 1.0e-5)
@assert isapprox(best[3], 3.82114998, atol = 1.0e-5)
@assert isapprox(best[4], 1.37940829, atol = 1.0e-5)
