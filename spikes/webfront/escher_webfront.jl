mutable struct RandWalker
    ...
    function RandWalker(reporter = nothing)
        return new(0, 0.0, 0.0, Inf, reporter)
    end
end
...
function main(window)
    ...
    if !haskey(task_local_storage(), :fhistory)
        ...
        function report_new_min(i::Int, newmin::Float64)
            return push!(fitness_history, push!(value(fitness_history), (i, newmin)))
        end
    ...
    return lift(task_local_storage(:fhistory)) do hist
